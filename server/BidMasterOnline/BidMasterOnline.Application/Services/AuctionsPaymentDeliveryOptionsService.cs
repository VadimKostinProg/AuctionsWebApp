...
namespace BidMasterOnline.Application.Services
{
    ...
    {
        private readonly IAsyncRepository _reporotiry;
        private readonly IAuthService _authService;
        private readonly INotificationsService _notificationsService;

        public AuctionsPaymentDeliveryOptionsService(IAsyncRepository reporotiry, IAuthService authService, INotificationsService notificationsService)
        {
        ...
        public async Task ConfirmDeliveyForAuctionAsync(ConfirmDeliveryDTO request)
        {
            ...
            _notificationsService.SendMessageOfDeliveryOptionsSetToWinner(auction, paymentDeliveryOptions.Winner);
        }
        ...
        public async Task<AuctionPaymentDeliveryOptionsDTO> GetPaymentDeliveryOptionsForAuctionIdAsync(Guid auctionId)
        {
            var auction = await _reporotiry.GetByIdAsync<Auction>(auctionId);
            ...
            return new AuctionPaymentDeliveryOptionsDTO
            {
                ...
                WinnersUsername = paymentDeliveryOptions.Winner.Username,
                ...
                PaymentConfirmationDateTime = paymentDeliveryOptions.PaymentConfirmationDateTime,
                IsDeliveryConfirmed = paymentDeliveryOptions.IsDeliveryConfirmed,
                DeliveryConfirmationDateTime = paymentDeliveryOptions.DeliveryConfirmationDateTime,
